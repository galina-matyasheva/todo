...
export const Note = ({entry, editableKey, handleOnClicked, handleEdit, onDoubleClickInput, deleteItem}) => {
    console.log(editableKey,entry.key, 'ffff');
    return (
        ...
        <li key={entry.key} style={{
            ...
            <div className="checkbox-round">
                ...
                <input
                    ...
                    type="checkbox" id={`${entry.key}-checkbox`} checked={entry.checked}
                    onChange={() => handleOnClicked(entry)}/>

                <label htmlFor={`${entry.key}-checkbox`} className={editableKey}> </label>
